...
void setup() {
  ...
  if (my_file){
    ...
    // ******************************** //
my_file.println(F("' onchange='update_program_number(this)'></div>"));
my_file.print(F("    <div class='program'><label>Program Speed:</label><input class='speed_input' type='number' id='speed_ui' value='"));
    // ******************************** //
    // End copy and paste
    // ******************************** //
