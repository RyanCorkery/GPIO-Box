...
my_file.println(F("    margin-top: 0;"));
my_file.println(F("    text-align: center;"));
my_file.println(F("    border-bottom: 2px solid darkslategray;"));
my_file.println(F("}"));
my_file.println(F("#list_form { "));
my_file.println(F("    margin-bottom: 0;"));
my_file.println(F("}"));
...
my_file.println(F("    margin: 5px 5px 0 0;"));
my_file.println(F("}"));
...
my_file.println(F("    <div class='program'><label>Program Number:</label><input type='number' id='program_ui' value='' onchange='update_program_number(this)'></div>"));
my_file.println(F("    <div class='program'><label>Program Speed:</label><input class='speed_input' type='number' id='speed_ui' value='' onchange='update_program_speed(this)'>[ms], period of each step</div>"));
...
my_file.println(F("            <div><input type='checkbox'></div>"));
my_file.println(F("            <div><input type='checkbox'></div>"));
my_file.println(F("            <div><input type='number' value='0' onchange='limit_break(this)'></div>"));
my_file.println(F("            <div><input type='number' value='0' onchange='limit_break(this)'></div>"));
my_file.println(F("            <div><input type='number' value='0' onchange='limit_break(this)'></div>"));
my_file.println(F("            <div><input type='number' value='0' onchange='limit_break(this)'></div>"));
my_file.println(F("            <div><input type='number' value='0' onchange='limit_break(this)'></div>"));
...
my_file.println(F("    <label>Program description:</label><input type='text' value='' id='description' name='description' maxlength='100'>Limit 100 characters<br>"));
