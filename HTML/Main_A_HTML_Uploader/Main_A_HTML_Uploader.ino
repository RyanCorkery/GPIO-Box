...
my_file.println(F("    <div class='program'><label>Program Number:</label><input id='program_ui' value='' onchange='update_program_number()'></div>"));
my_file.println(F("    <div class='program'><label>Program Speed:</label><input id='speed_ui' value='' onchange='update_program_speed()'></div>"));
