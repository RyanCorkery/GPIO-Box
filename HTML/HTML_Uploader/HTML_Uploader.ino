...
my_file.println(F("    <input type='submit' value='Save program'><br><br>"));
...
my_file.println(F("            var original = document.getElementById('my_form').children[x+1].value;                                                           '                                      '"));
my_file.println(F(""));
...
my_file.println(F("                        document.getElementById('my_form').children[x+1].value = original;"));
my_file.println(F("                    }   "));
my_file.println(F("                }"));
my_file.println(F("            }"));
