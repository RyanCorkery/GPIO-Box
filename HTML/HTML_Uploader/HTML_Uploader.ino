...
my_file.println("");
my_file.println("<button onclick='save_data()'>Save data</button> ");
my_file.println("");
...
my_file.println("    <div id='div2'>00000000000000000000000000000000000000</div>");
...
my_file.println("                    var original = document.getElementById('div2').innerHTML;");
my_file.println("                    var new_string = replaceChar(original, '1', i);");
my_file.println("                    document.getElementById('div2').innerHTML = new_string;");
my_file.println("                }   ");
my_file.println("            }");
my_file.println("        }");
